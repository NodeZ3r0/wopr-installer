...
register_module(Module(id="calcom", name="Cal.com", description="Appointment scheduling", category=ModuleCategory.PRODUCTIVITY, tier=ModuleTier.LOW, container_image="calcom/cal.com:latest", default_port=3000, sso_type=SSOType.OIDC, bundles=["creator","professional","small_business"], dependencies=["postgresql"], subdomain="cal", ram_mb=512, monthly_addon_price=4.99, trial_eligible=True, replaces="Calendly"))
